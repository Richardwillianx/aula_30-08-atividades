...
// negativo.
class ContaCorrente {
    construtor(numeroContaInc, nomeCorrentistaInc, saldoInc) {
    ...
    alteraNome(novoNome) {
        ...
        console.log(`o nome do correntista foi alterado para ${this.nomeCorrentista}`);
    }
    ...
    saque(novoSaque) {
        if (this.saldo - novoSaque > 0) {
            ...
            console.log(`Seu saldo após o saque de R$${novoSaque} é de R${this.saldo}`);
        }
    }
}
